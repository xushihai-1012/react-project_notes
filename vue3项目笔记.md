...
##### 2.3创建.prettierignore忽略文件添加如下配置
...
安装依赖:https://www.npmjs.com/package/vite-plugin-mock   注意vite-plugin-mock3.0.0版本有问题
